...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || '𝕆𝕤𝕙𝕚𝕝𝕒𝕋𝕍 Bot',
    ...
    BOT_INFO: process.env.BOT_INFO || 'ʜᴇʀᴍɪᴛ;𝕆𝕤𝕙𝕚𝕝𝕒𝕋𝕍 Bot;http://Wa.me/2347088589751;https://i.imgur.com/6oRG106.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'ʜᴇʀᴍɪᴛ;𝕆𝕤𝕙𝕚𝕝𝕒𝕋𝕍;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'ʜᴇʀᴍɪᴛ;𝕆𝕤𝕙𝕚𝕝𝕒𝕋𝕍' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '2349166693315,0',
       DEBUG: DEBUG
};
