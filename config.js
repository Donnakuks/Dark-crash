...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || '𝚩𝐋𝚫𝐂𝐊𝚾𝚭' ,
    ...
    BOT_INFO: process.env.BOT_INFO || '𝚩𝐋𝚫𝐂𝐊𝚾𝚭;𝚴𝚯𝚵𝐋;https://i.imgur.com/69k7cOZ.jpeg',

    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? '𝚩𝐋𝚫𝐂𝐊𝚾𝚭;𝚴𝚯𝚵𝐋;https://i.imgur.com/69k7cOZ.jpeg' : process.env.AUDIO_DATA,

    STICKER_DATA: process.env.STICKER_DATA === undefined ? '𝚩𝐋𝚫𝐂𝐊𝚾𝚭;𝚴𝚯𝚵𝐋' : process.env.STICKER_DATA,
