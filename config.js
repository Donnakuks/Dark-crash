...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'ʜᴇʀᴍɪᴛ;ᴀᴅɪᴛʜyᴀɴ;923406902086;https://imgur.com/gallery/wIz0ZRm',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'ʜᴇʀᴍɪᴛ;ᴀᴅɪᴛʜyᴀɴ;https://imgur.com/gallery/wIz0ZRm' : process.env.AUDIO_DATA,
