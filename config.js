...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'GLITCH BOT',
    ...
    BOT_INFO: process.env.BOT_INFO || 'glitch;vintage;265995013516;https://i.imgur.com/6oRG106.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'glitch;vintage;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'glithvintage' : process.env.STICKER_DATA,
