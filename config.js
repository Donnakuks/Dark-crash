...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || '𝛨𝛯𝑅𝛭𝛪𝑇;𝛥𝐷𝛪𝑇𝛨𝑌𝛥𝛮;972528277755; https://i.imgur.com/fhVZChv.jpg ',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'Arslan king'; https://i.imgur.com/fhVZChv.jpg .jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'Arslan king' : process.env.STICKER_DATA,
