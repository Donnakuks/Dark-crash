...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'legendz md ᵇʸ:ˢʰⁱᵏᵃᵗʰᵉʲᵃⁿ',
    ...
    BOT_INFO: process.env.BOT_INFO || 'lejendz md;ˢʰⁱᵏᵃ ᵗʰᵉʲᵃⁿ;94715442757;https://i.imgur.com/6oRG106.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'lejendz md;ˢʰⁱᵏᵃ ᵗʰᵉʲᵃⁿ;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'lejendz md;ˢʰⁱᵏᵃ ᵗʰᵉʲᵃⁿ' : process.env.STICKER_DATA,
