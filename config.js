...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'PH-MD-WA-BOT',
    ...
    BOT_INFO: process.env.BOT_INFO || "PH-MD-WA-BOT;PASINDU THARAKA;94741468976;'https://i.ibb.co/Nm1SWmz/20221103-153258.gif,
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'PH-MD-WA-BOT;PASINDU THARAKA;https://i.ibb.co/Nm1SWmz/20221103-153258.gif, : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'PH-MD-WA-BOT;PASINDU THARAKA' : process.env.STICKER_DATA,
