...
module.exports = {
	VERSION: 'v4.4.1', 
    SESSION_ID: process.env.SESSION_ID || '12_13_H_E_R_M_I_T_YIUJP98',
    ...
    BOT_NAME: process.env.BOT_NAME || 'MORICE',
    ...
    BOT_INFO: process.env.BOT_INFO || 'MORICE;moriceug;256761565724;https://i.imgur.com/6oRG106.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'MORICE;moriceug;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'MORICE;moriceug' : process.env.STICKER_DATA,
