...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || '𝑫𝑬𝑵𝑰𝑺,
    ...
    BOT_INFO: process.env.BOT_INFO || '𝛨𝛯𝑅𝛭𝛪𝑇;𝑫𝑬𝑵𝑰𝑺;652145256;https://i.imgur.com/6oRG106.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? '𝛨𝛯𝑅𝛭𝛪𝑇;𝛥𝐷𝛪𝑇𝛨𝑌𝛥𝛮;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? '𝑴𝑨𝑫𝑨𝑹𝑨 𝑼𝑪𝑯𝑰𝑾𝑨: process.env.STICKER_DATA,
