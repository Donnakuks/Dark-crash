...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'swagsir',
    BOT_INFO: process.env.BOT_INFO || 'swagsir;nitheesh;9656593170;https://i.imgur.com/6oRG106.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'Swagsir;nitheesh;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'Swagsir;nitheesh' : process.env.AUDIO_DATA,
