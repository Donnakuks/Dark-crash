...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'MINEMAX',
    ...
    BOT_INFO: process.env.BOT_INFO || 'MINEMAX;BOT;08169332768;https://i.imgur.com/6oRG106.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'ʜᴇʀᴍɪᴛ;ᴀᴅɪᴛʜyᴀɴ;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'MINEMAX;PACK' : process.env.STICKER_DATA,
