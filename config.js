...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || '𝐵𝑅𝐼𝒢𝐻𝒯𝒪𝒩𝐸𝒮',
    ...
    BOT_INFO: process.env.BOT_INFO || '𝐵𝑅𝐼𝒢𝐻𝒯𝒪𝒩𝐸𝒮;𝐵𝑅𝐼𝒢𝐻𝒯𝒪𝒩𝐸;972528277755;https://i.imgur.com/6oRG106.jpeg',

    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? '𝐵𝑅𝐼𝒢𝐻𝒯𝒪𝒩𝐸𝒮;𝐵𝑅𝐼𝒢𝐻𝒯𝒪𝒩𝐸;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,

    STICKER_DATA: process.env.STICKER_DATA === undefined ? '𝐵𝑅𝐼𝒢𝐻𝒯𝒪𝒩𝐸𝒮;𝐵𝑅𝐼𝒢𝐻𝒯𝒪𝒩𝐸' : process.env.STICKER_DATA,
