...
module.exports = {
	VERSION: 'v4.3.9', 
    SESSION_ID: process.env.SESSION_ID || '06_19_H_E_R_M_I_T_OL_JC4H',
    ...
    BOT_NAME: process.env.BOT_NAME || 'Ibrahim',
    ...
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'Ibrahim' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '2347017071590,0',
       DEBUG: DEBUG
};
