...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'Hermit;Adithyan;972528277755;https://i.imgur.com/6oRG106.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'Hermit;Adithyan;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'Hermit;Adithyan' : process.env.STICKER_DATA,
