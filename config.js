...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'ANDY-MD;MAXI;50941411147;https://i.imgur.com/6oRG106.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? '𝛨𝛯𝑅𝛭𝛪𝑇;ANDY;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'ANDYMD;HACKE' : process.env.AUDIO_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '50941411147,0',
       DEBUG: DEBUG
};
