...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'CEO BOTS',
    ...
    BOT_INFO: process.env.BOT_INFO || 'ʜᴇʀᴍɪᴛ;ᴀᴅɪᴛʜyᴀɴ;972528277755;https://iili.io/J1aDGON.md.jpg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'ʜᴇʀᴍɪᴛ;ᴀᴅɪᴛʜyᴀɴ;https://iili.io/J1aDGON.md.jpg' : process.env.AUDIO_DATA,
